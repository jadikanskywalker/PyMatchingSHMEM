...
//                         }
// #endif
                        // solver_id = get_solver_id(shot_container_id, iamleft ? t->part : sibling->part, tid);
...
//                             t->setup();
//                             if (DEBUG) {
//                                 t_out << "  sending solution to PE" << ((t->fusion_left_pid == pid) ? t->fusion_right_pid : t->fusion_left_pid) << std::endl;
//                             }
