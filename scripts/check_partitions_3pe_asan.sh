...
#SBATCH --output=/mnt/DISCL/home/jadhicks/PyMatchingSHMEM/verify_out/check_partitions_3pe_asan-%j.out
source ~/.bash_profile
...
oshrun -n 3 build_asan_throwaway/pymatching predict \
  ...
  --out verify_out/round_pred_3pe_asan.01 --out_format 01 \
  --rounds_per_partition 2 \
  --extraction_unit_size 4 \
  --extract_preemptively \
  > verify_out/check_partitions_3pe_asan.stdout 2>&1
echo "exit=$?" >> verify_out/check_partitions_3pe_asan.stdout
