#!/bin/bash
#SBATCH --job-name=repro_36obs_asan_fixed
#SBATCH --partition=zen4
#SBATCH --time=03:00:00
#SBATCH --nodes=1
#SBATCH --exclusive
#SBATCH --mem=256GB
#SBATCH --output=repro_36obs_asan_fixed-%j.out
#SBATCH --error=repro_36obs_asan_fixed-%j.err
...
mkdir -p repro_36obs_threads_fixed
cd repro_36obs_threads_fixed
